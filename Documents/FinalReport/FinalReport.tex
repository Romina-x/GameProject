...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{UMLDiagrams/AnimalRescueUML.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{UMLDiagrams/SoundFXSingletonUML.drawio.png}
    \caption{UML Class diagram of Singleton Pattern}
