...
\newline
Frustum Culling is a technique similar to Occlusion Culling, which focusses on avoiding rendering computations for game objects that are outside of the game camera's view.
